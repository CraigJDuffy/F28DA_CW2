...
public class PartC {
	 ...
	 *
	 * This class performs the actions associated with part C of the course
	 * work. Most of the unique part C stuff is done in Flight.java.
	 *
	 */

	// The main method creates a simpleDirectedGraph: flightGraph.
	...
	private static SimpleDirectedWeightedGraph<String, Flight> createFlightGraph() {
		...
		// Add all the vertexes to the graph (non-case sensitive).
